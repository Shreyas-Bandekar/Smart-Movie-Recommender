...
def _artifact_path(filename: str) -> str:
    """
    Prefer the structured models/ directory, but keep a legacy root fallback.
    """
...
DF_PATH = _artifact_path("df.pkl")
INDICES_PATH = _artifact_path("indices.pkl")
TFIDF_MATRIX_PATH = _artifact_path("tfidf_matrix.pkl")
